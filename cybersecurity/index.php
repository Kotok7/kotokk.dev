...
$translations = [
    'en' => [
        ...
        'footer_copy'          => '&copy; 2025 kotokk.dev<br>All rights reserved.',
        'linktree'             => 'Link to devices and modules',
        'linktreeinfo'         => 'All the devices and modules I use are <a href="link.php">here</a> (with purchase links)',
    ...
    'pl' => [
        ...
        'contact_discord'      => 'Discord: @kotokk_dev',
        'footer_copy'          => '&copy; 2025 kotokk.dev<br>Wszelkie prawa zastrzeżone.',
        'linktree'             => 'Link do urządzeń i modułów',
        'back_button'          => 'Wróć do strony głównej',
        'linktreeinfo'         => 'Wszystkie urządzenia i moduły które używam, są zebrane <a href="link.php">tutaj</a> (z linkami do zakupu)',
