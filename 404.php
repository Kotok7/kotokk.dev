...
$catalogs = [
    ...
    'pl' => [
        ...
        ['name' => 'Udostępniaj i odkrywaj muzykę', 'url' => '/share-music'],
        ['name' => 'Fakty, cytaty i żarty', 'url' => '/facts'],
        ['name' => 'Jak być jak ja', 'url' => '/tutorial'],
        ['name' => 'Quiz o mnie', 'url' => '/quiz'],
        ['name' => 'Narzędzia kwantowe', 'url' => '/quantum-tools'],
        ['name' => 'Blog', 'url' => '/blog'],
        ['name' => 'Konwerter czasu', 'url' => '/time-converter'],
        ...
        ['name' => 'Agartha or hyperborea quiz (ukryte)', 'url' => '/agartha-or-hyperborea'],
